...
class MyMainWindow(QMainWindow, Ui_MainWindow):
    ...
    def getChosenSoup(self, date_num, keyword):
        page = 1
        title_list = []
        link_list = []
    ...
    def showContent(self):
        ...
        for keyword in keywords:
            title_list, link_list = self.getChosenSoup(int(datenum), keyword)
            try:
                ...
                print('showContent somethings wrong')
...
class SecondWindow(QWidget):
    ...
    def add_listItem(self):
        ...
        conn = sqlite3.connect(dbfile)
        c = conn.cursor()
        sqlstr = "Select 1 From Fav Where keyword = '" + addinput + "'"
        c.execute(sqlstr)

        if addinput.isspace() is False and len(addinput) != 0:
            if c.fetchone() == (1,):
                print(addinput + " 已存在")
            else:
                insertSQL = "Insert into Fav(Keyword) values('{}');".format(addinput)
